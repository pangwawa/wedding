        ...
        <div class="user-form-wrap">
            <div class="user-form-wraps">
                ...
                <form data-form="userlogin" action="login" method="post" onsubmit="return checkInput()">
                    <div class="user-form-item">
                        <input class="user-input" name="user_tel" id="user_tel" type="text" max="15" maxlength="15" placeholder="手机号"></div>
                    <div class="user-form-item">
                    ...
                    <div class="user-form-item">
                        <input class="user-input user-input-adjust" id="vcode" name="vcode" type="text" max="4" placeholder="验证码"><img class="qrcode" src="DrawCode" id="prove" title="换一张" alt="加载中" onclick="change()" style="cursor:pointer;"></div>
